create or replace package eba_demo_appr as
    ...
    --
    function rejection_delay_until_time return date;
...
-- sqlcl_snapshot {"hash":"d1b8dfba713b1a5de1f504a4b3e91dd7f1b245aa","type":"PACKAGE_SPEC","name":"EBA_DEMO_APPR","schemaName":"MOVIESTREAM","sxml":""}