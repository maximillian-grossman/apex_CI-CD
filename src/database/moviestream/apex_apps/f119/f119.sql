...
,p_default_id_offset=>16589369186080235
,p_default_owner=>'MOVIESTREAM'
);
end;
/
 
prompt APPLICATION 119 - Sample REST Services
--
-- Application Export:
--   Application:     119
--   Name:            Sample REST Services
...
,p_authentication_id=>wwv_flow_imp.id(10563475101487172413)
...
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(750255372996446286)
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'Sample Application - Github Repository Commits'
,p_format=>'JSON'
,p_use_raw_json_selectors=>false
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91388986884483371)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'SHA'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91389451996483371)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'NAME'
,p_sequence=>2
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91389782367483371)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'EMAIL'
,p_sequence=>3
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91390212302483371)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'DATE_'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91390625598483371)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91390982458483371)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'EMAIL_2'
,p_sequence=>6
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91391451582483372)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'DATE_2'
,p_sequence=>7
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91391794499483372)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'MESSAGE'
,p_sequence=>8
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91392253158483372)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'SHA_2'
,p_sequence=>9
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91392609251483372)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'URL'
,p_sequence=>10
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91393007769483372)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'URL_2'
,p_sequence=>11
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91393417943483372)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91393781700483373)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'VERIFIED'
,p_sequence=>13
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91394178472483373)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'REASON'
,p_sequence=>14
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91394612921483373)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'SIGNATURE'
,p_sequence=>15
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91394998468483373)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'PAYLOAD'
,p_sequence=>16
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91395400547483373)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'URL_3'
,p_sequence=>17
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91395852207483373)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'HTML_URL'
,p_sequence=>18
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91396264443483374)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'COMMENTS_URL'
,p_sequence=>19
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91396650953483374)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'LOGIN'
,p_sequence=>20
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91397045842483374)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'ID'
,p_sequence=>21
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91397412879483374)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'AVATAR_URL'
,p_sequence=>22
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91397873118483374)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'GRAVATAR_ID'
,p_sequence=>23
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91398221744483374)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'URL_4'
,p_sequence=>24
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91398602622483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'HTML_URL_2'
,p_sequence=>25
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91399022412483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91399390513483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91399847757483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'GISTS_URL'
,p_sequence=>28
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91400234538483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'STARRED_URL'
,p_sequence=>29
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91400639897483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91400979333483375)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91401472813483376)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'REPOS_URL'
,p_sequence=>32
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91401864717483376)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'EVENTS_URL'
,p_sequence=>33
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91402189183483376)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91402625670483376)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'TYPE'
,p_sequence=>35
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91403022263483376)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'SITE_ADMIN'
,p_sequence=>36
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91403451403483376)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91403831512483377)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'ID_2'
,p_sequence=>38
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91404223869483377)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91404644149483377)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91405039546483377)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'URL_5'
,p_sequence=>41
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91405439009483377)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'HTML_URL_3'
,p_sequence=>42
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91405783402483377)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91406231250483378)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91406587559483378)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'GISTS_URL_2'
,p_sequence=>45
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91407053852483378)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91407424636483378)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91407844359483378)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91408258198483378)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'REPOS_URL_2'
,p_sequence=>49
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91408655195483379)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'EVENTS_URL_2'
,p_sequence=>50
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91409071956483379)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91409423192483379)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'TYPE_2'
,p_sequence=>52
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(91409796428483379)
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_name=>'SITE_ADMIN_2'
,p_sequence=>53
,p_data_type=>'VARCHAR2'
...
begin
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'Github Repositories'
,p_format=>'JSON'
,p_use_raw_json_selectors=>false
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762575217365086486)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'ID'
,p_sequence=>1
,p_data_type=>'NUMBER'
,p_has_time_zone=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762575612390086489)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'NAME'
,p_sequence=>2
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762576010051086500)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FULL_NAME'
,p_sequence=>3
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762576369575086533)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'LOGIN'
,p_sequence=>4
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762576681463086544)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'ID_2'
,p_sequence=>5
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762577152681086545)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'AVATAR_URL'
,p_sequence=>6
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762577505992086545)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'GRAVATAR_ID'
,p_sequence=>7
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762577879093086546)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'URL'
,p_sequence=>8
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762578324783086546)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HTML_URL'
,p_sequence=>9
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762578732118086546)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FOLLOWERS_URL'
,p_sequence=>10
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762579137233086546)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FOLLOWING_URL'
,p_sequence=>11
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762579486935086547)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'GISTS_URL'
,p_sequence=>12
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762579938085086547)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'STARRED_URL'
,p_sequence=>13
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762580338657086547)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'SUBSCRIPTIONS_URL'
,p_sequence=>14
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762580710217086547)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'ORGANIZATIONS_URL'
,p_sequence=>15
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762581095292086548)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'REPOS_URL'
,p_sequence=>16
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762581509571086548)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'EVENTS_URL'
,p_sequence=>17
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762581922609086549)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'RECEIVED_EVENTS_URL'
,p_sequence=>18
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762582361884086549)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'TYPE'
,p_sequence=>19
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762582743076086549)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'SITE_ADMIN'
,p_sequence=>20
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762583122363086550)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'PRIVATE'
,p_sequence=>21
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762583514795086550)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HTML_URL_2'
,p_sequence=>22
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762583935365086551)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'DESCRIPTION'
,p_sequence=>23
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762584354422086551)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FORK'
,p_sequence=>24
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762584761539086551)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'URL_2'
,p_sequence=>25
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762585096853086552)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FORKS_URL'
,p_sequence=>26
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762585548050086552)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'KEYS_URL'
,p_sequence=>27
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762585956589086553)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762586296819086553)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'TEAMS_URL'
,p_sequence=>29
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762586750885086553)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HOOKS_URL'
,p_sequence=>30
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762587094121086558)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762587543866086558)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'EVENTS_URL_2'
,p_sequence=>32
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762587912208086559)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762588301498086559)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'BRANCHES_URL'
,p_sequence=>34
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762588751587086560)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'TAGS_URL'
,p_sequence=>35
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762589093671086560)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'BLOBS_URL'
,p_sequence=>36
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762589541766086560)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'GIT_TAGS_URL'
,p_sequence=>37
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762589920669086561)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'GIT_REFS_URL'
,p_sequence=>38
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762590350735086561)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'TREES_URL'
,p_sequence=>39
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762590743828086562)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'STATUSES_URL'
,p_sequence=>40
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762591114490086562)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762591516728086562)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762591933569086562)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762592364402086563)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762592688801086563)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762593144347086563)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'COMMITS_URL'
,p_sequence=>46
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762593481113086563)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762593916879086563)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'COMMENTS_URL'
,p_sequence=>48
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762594333132086564)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762594719774086564)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'CONTENTS_URL'
,p_sequence=>50
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762595108752086565)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'COMPARE_URL'
,p_sequence=>51
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762595547242086565)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'MERGES_URL'
,p_sequence=>52
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762595946980086565)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'ARCHIVE_URL'
,p_sequence=>53
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762596348673086566)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762596733968086566)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'ISSUES_URL'
,p_sequence=>55
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762597099559086566)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'PULLS_URL'
,p_sequence=>56
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762597547994086566)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762597922133086567)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762598345850086567)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'LABELS_URL'
,p_sequence=>59
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762598684226086567)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'RELEASES_URL'
,p_sequence=>60
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762599083802086567)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762599538542086567)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'CREATED_AT'
,p_sequence=>62
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762599926136086570)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'UPDATED_AT'
,p_sequence=>63
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762600285336086570)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'PUSHED_AT'
,p_sequence=>64
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762600695707086570)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'GIT_URL'
,p_sequence=>65
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762601136366086570)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'SSH_URL'
,p_sequence=>66
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762601562316086571)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'CLONE_URL'
,p_sequence=>67
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762601890208086571)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'SVN_URL'
,p_sequence=>68
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762602308500086571)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HOMEPAGE'
,p_sequence=>69
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762602750064086571)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'SIZE_'
,p_sequence=>70
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762603123313086571)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762603552066086572)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762603960492086572)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'LANGUAGE'
,p_sequence=>73
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762604317992086572)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HAS_ISSUES'
,p_sequence=>74
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762604721684086572)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HAS_PROJECTS'
,p_sequence=>75
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762605140846086572)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762605536825086573)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HAS_WIKI'
,p_sequence=>77
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762605968174086573)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'HAS_PAGES'
,p_sequence=>78
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762606280962086573)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FORKS_COUNT'
,p_sequence=>79
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762606717330086573)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'MIRROR_URL'
,p_sequence=>80
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762607114878086573)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'ARCHIVED'
,p_sequence=>81
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762607553159086574)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762607957561086574)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'KEY'
,p_sequence=>83
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762608333520086574)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'NAME_2'
,p_sequence=>84
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762608685131086574)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'SPDX_ID'
,p_sequence=>85
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762609125764086574)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'URL_3'
,p_sequence=>86
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762609495260086575)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'FORKS'
,p_sequence=>87
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762609916497086575)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'OPEN_ISSUES'
,p_sequence=>88
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762610311749086575)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'WATCHERS'
,p_sequence=>89
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762610709998086575)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762611148916086575)
,p_data_profile_id=>wwv_flow_imp.id(762575015063086479)
,p_name=>'LICENSE'
,p_sequence=>91
,p_data_type=>'VARCHAR2'
...
begin
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'Github Repository Issues'
,p_format=>'JSON'
,p_use_raw_json_selectors=>false
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762612572210116664)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'URL'
,p_sequence=>1
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762612973516116667)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762613283562116673)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'LABELS_URL'
,p_sequence=>3
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762613734484116676)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'COMMENTS_URL'
,p_sequence=>4
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762614105946116681)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'EVENTS_URL'
,p_sequence=>5
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762614506426116681)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'HTML_URL'
,p_sequence=>6
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762614905764116681)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'ID'
,p_sequence=>7
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762615333476116681)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'NUMBER_'
,p_sequence=>8
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762615702985116681)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'TITLE'
,p_sequence=>9
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762616134854116682)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'USER_LOGIN'
,p_sequence=>10
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762616524658116682)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'USER_ID'
,p_sequence=>11
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762616947795116682)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762617347990116683)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'GRAVATAR_ID'
,p_sequence=>13
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762617743851116683)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'URL_2'
,p_sequence=>14
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762618161269116683)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'HTML_URL_2'
,p_sequence=>15
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762618495851116684)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'FOLLOWERS_URL'
,p_sequence=>16
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762618926482116684)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'FOLLOWING_URL'
,p_sequence=>17
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762619357255116685)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'GISTS_URL'
,p_sequence=>18
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762619745768116685)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'STARRED_URL'
,p_sequence=>19
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762620084629116685)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'SUBSCRIPTIONS_URL'
,p_sequence=>20
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762620503557116685)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'ORGANIZATIONS_URL'
,p_sequence=>21
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762620936490116685)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'REPOS_URL'
,p_sequence=>22
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762621352293116686)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'EVENTS_URL_2'
,p_sequence=>23
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762621762508116686)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'RECEIVED_EVENTS_URL'
,p_sequence=>24
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762622084528116686)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'USER_TYPE'
,p_sequence=>25
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762622486278116686)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'SITE_ADMIN'
,p_sequence=>26
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762622937845116686)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'STATE'
,p_sequence=>27
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762623373620116687)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'LOCKED'
,p_sequence=>28
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762623748796116687)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'ASSIGNEE'
,p_sequence=>29
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762624141117116687)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'MILESTONE'
,p_sequence=>30
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762624500950116687)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'COMMENTS'
,p_sequence=>31
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762624943444116688)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'CREATED_AT'
,p_sequence=>32
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762625299844116688)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'UPDATED_AT'
,p_sequence=>33
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762625743995116688)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'CLOSED_AT'
,p_sequence=>34
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762626144378116689)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762626528854116689)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'URL_3'
,p_sequence=>36
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762626927908116689)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'HTML_URL_3'
,p_sequence=>37
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762627305272116689)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'DIFF_URL'
,p_sequence=>38
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762627705091116689)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'PATCH_URL'
,p_sequence=>39
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762628145868116690)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'BODY'
,p_sequence=>40
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762628526168116690)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762628956180116690)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'ASSIGNEE_ID'
,p_sequence=>42
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762629356591116690)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762629694785116690)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'GRAVATAR_ID_2'
,p_sequence=>44
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762630094277116691)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'URL_4'
,p_sequence=>45
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762630537663116691)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'HTML_URL_4'
,p_sequence=>46
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762630970952116691)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'FOLLOWERS_URL_2'
,p_sequence=>47
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762631287946116691)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'FOLLOWING_URL_2'
,p_sequence=>48
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762631763001116691)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'GISTS_URL_2'
,p_sequence=>49
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762632169709116691)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'STARRED_URL_2'
,p_sequence=>50
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762632554206116692)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'SUBSCRIPTIONS_URL_2'
,p_sequence=>51
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762632959069116692)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'ORGANIZATIONS_URL_2'
,p_sequence=>52
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762633341509116692)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'REPOS_URL_2'
,p_sequence=>53
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762633739949116692)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'EVENTS_URL_3'
,p_sequence=>54
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762634089061116692)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'RECEIVED_EVENTS_URL_2'
,p_sequence=>55
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762634498242116693)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'TYPE_2'
,p_sequence=>56
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762634948012116693)
,p_data_profile_id=>wwv_flow_imp.id(762612284681116663)
,p_name=>'SITE_ADMIN_2'
,p_sequence=>57
,p_data_type=>'VARCHAR2'
...
begin
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'Github Repository Pulls'
,p_format=>'JSON'
,p_use_raw_json_selectors=>false
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762636692616123160)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL'
,p_sequence=>1
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762637118952123177)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID'
,p_sequence=>2
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762637528484123181)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL'
,p_sequence=>3
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762637898720123199)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'DIFF_URL'
,p_sequence=>4
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762638279525123199)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PATCH_URL'
,p_sequence=>5
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762638623370123200)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ISSUE_URL'
,p_sequence=>6
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762639029891123200)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'NUMBER_'
,p_sequence=>7
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762639430601123200)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'STATE'
,p_sequence=>8
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762639778036123201)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LOCKED'
,p_sequence=>9
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762640185732123201)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TITLE'
,p_sequence=>10
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762640597148123202)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LOGIN'
,p_sequence=>11
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762641062716123202)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_2'
,p_sequence=>12
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762641453184123203)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AVATAR_URL'
,p_sequence=>13
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762641793752123203)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GRAVATAR_ID'
,p_sequence=>14
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762642182246123203)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_2'
,p_sequence=>15
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762642592200123204)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_2'
,p_sequence=>16
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762643042240123204)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FOLLOWERS_URL'
,p_sequence=>17
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762643454434123204)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FOLLOWING_URL'
,p_sequence=>18
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762643782628123204)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GISTS_URL'
,p_sequence=>19
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762644190735123204)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'STARRED_URL'
,p_sequence=>20
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762644673925123205)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SUBSCRIPTIONS_URL'
,p_sequence=>21
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762645050310123205)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ORGANIZATIONS_URL'
,p_sequence=>22
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762645443051123205)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPOS_URL'
,p_sequence=>23
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762645790649123205)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL'
,p_sequence=>24
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762646202851123205)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'RECEIVED_EVENTS_URL'
,p_sequence=>25
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762646613285123206)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TYPE'
,p_sequence=>26
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762647053695123206)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SITE_ADMIN'
,p_sequence=>27
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762647405156123206)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'BODY'
,p_sequence=>28
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762647784722123206)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CREATED_AT'
,p_sequence=>29
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762648234555123206)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'UPDATED_AT'
,p_sequence=>30
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762648587984123207)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CLOSED_AT'
,p_sequence=>31
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762649071930123207)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MERGED_AT'
,p_sequence=>32
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762649430878123207)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762649813095123207)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ASSIGNEE'
,p_sequence=>34
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762650219364123207)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MILESTONE'
,p_sequence=>35
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762650590817123208)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'COMMITS_URL'
,p_sequence=>36
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762651062973123208)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762651455852123208)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762651796395123208)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'COMMENTS_URL'
,p_sequence=>39
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762652237715123208)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'STATUSES_URL'
,p_sequence=>40
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762652586237123209)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LABEL'
,p_sequence=>41
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762652998258123209)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REF'
,p_sequence=>42
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762653417962123209)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SHA'
,p_sequence=>43
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762653865967123209)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LOGIN_2'
,p_sequence=>44
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762654255254123210)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_3'
,p_sequence=>45
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762654666964123210)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AVATAR_URL_2'
,p_sequence=>46
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762655022553123210)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GRAVATAR_ID_2'
,p_sequence=>47
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762655435515123210)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_3'
,p_sequence=>48
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762655824173123210)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_3'
,p_sequence=>49
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762656236229123211)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FOLLOWERS_URL_2'
,p_sequence=>50
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762656584787123211)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FOLLOWING_URL_2'
,p_sequence=>51
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762657030828123211)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GISTS_URL_2'
,p_sequence=>52
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762657396508123211)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'STARRED_URL_2'
,p_sequence=>53
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762657860074123211)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SUBSCRIPTIONS_URL_2'
,p_sequence=>54
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762658272843123212)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ORGANIZATIONS_URL_2'
,p_sequence=>55
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762658612784123212)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPOS_URL_2'
,p_sequence=>56
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762658990705123212)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_2'
,p_sequence=>57
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762659463443123212)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'RECEIVED_EVENTS_URL_2'
,p_sequence=>58
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762659811560123212)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TYPE_2'
,p_sequence=>59
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762660237533123213)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SITE_ADMIN_2'
,p_sequence=>60
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762660614591123213)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_4'
,p_sequence=>61
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762661022748123213)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'NAME'
,p_sequence=>62
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762661473766123213)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FULL_NAME'
,p_sequence=>63
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762661776040123213)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LOGIN_3'
,p_sequence=>64
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762662246953123214)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_5'
,p_sequence=>65
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762662632175123214)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AVATAR_URL_3'
,p_sequence=>66
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762663043556123214)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762663425286123214)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_4'
,p_sequence=>68
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762663781629123214)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_4'
,p_sequence=>69
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762664269621123215)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762664616829123215)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762665016263123216)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GISTS_URL_3'
,p_sequence=>72
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762665384090123216)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762665853922123217)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762666200859123217)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762666628481123217)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPOS_URL_3'
,p_sequence=>76
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762667055351123217)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_3'
,p_sequence=>77
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762667470562123218)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762667834128123218)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TYPE_3'
,p_sequence=>79
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762668252522123218)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SITE_ADMIN_3'
,p_sequence=>80
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762668661639123219)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PRIVATE'
,p_sequence=>81
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762669035076123219)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_5'
,p_sequence=>82
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762669396409123226)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'DESCRIPTION'
,p_sequence=>83
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762669798371123227)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORK'
,p_sequence=>84
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762670227432123227)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_5'
,p_sequence=>85
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762670610864123228)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORKS_URL'
,p_sequence=>86
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762671037896123228)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'KEYS_URL'
,p_sequence=>87
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762671374552123229)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'COLLABORATORS_URL'
,p_sequence=>88
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762671854848123229)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TEAMS_URL'
,p_sequence=>89
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762672184511123230)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HOOKS_URL'
,p_sequence=>90
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762672618279123230)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ISSUE_EVENTS_URL'
,p_sequence=>91
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762672999871123230)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_4'
,p_sequence=>92
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762673438115123231)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ASSIGNEES_URL'
,p_sequence=>93
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762673822729123232)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'BRANCHES_URL'
,p_sequence=>94
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762674254012123232)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TAGS_URL'
,p_sequence=>95
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762674632197123232)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'BLOBS_URL'
,p_sequence=>96
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762675019441123233)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GIT_TAGS_URL'
,p_sequence=>97
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762675396456123233)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GIT_REFS_URL'
,p_sequence=>98
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762675867861123233)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TREES_URL'
,p_sequence=>99
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762676194839123233)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762676656101123233)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LANGUAGES_URL'
,p_sequence=>101
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762677003609123234)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'STARGAZERS_URL'
,p_sequence=>102
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762677461997123234)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CONTRIBUTORS_URL'
,p_sequence=>103
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762677807850123234)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SUBSCRIBERS_URL'
,p_sequence=>104
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762678190683123234)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SUBSCRIPTION_URL'
,p_sequence=>105
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762678637941123234)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762678977150123235)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GIT_COMMITS_URL'
,p_sequence=>107
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762679469433123235)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762679841236123235)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ISSUE_COMMENT_URL'
,p_sequence=>109
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762680181203123235)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CONTENTS_URL'
,p_sequence=>110
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762680597932123236)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'COMPARE_URL'
,p_sequence=>111
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762681046328123236)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MERGES_URL'
,p_sequence=>112
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762681450491123237)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ARCHIVE_URL'
,p_sequence=>113
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762681841806123237)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'DOWNLOADS_URL'
,p_sequence=>114
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762682248987123238)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ISSUES_URL'
,p_sequence=>115
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762682650877123238)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PULLS_URL'
,p_sequence=>116
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762682989877123238)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MILESTONES_URL'
,p_sequence=>117
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762683413470123238)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'NOTIFICATIONS_URL'
,p_sequence=>118
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762683864799123238)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LABELS_URL'
,p_sequence=>119
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762684198063123239)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'RELEASES_URL'
,p_sequence=>120
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762684579121123240)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'DEPLOYMENTS_URL'
,p_sequence=>121
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762685009278123241)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CREATED_AT_2'
,p_sequence=>122
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762685415459123241)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'UPDATED_AT_2'
,p_sequence=>123
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762685806595123241)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PUSHED_AT'
,p_sequence=>124
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762686205374123242)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GIT_URL'
,p_sequence=>125
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762686629915123243)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SSH_URL'
,p_sequence=>126
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762687028407123243)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CLONE_URL'
,p_sequence=>127
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762687410673123244)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SVN_URL'
,p_sequence=>128
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762687799474123244)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HOMEPAGE'
,p_sequence=>129
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762688224190123245)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SIZE_'
,p_sequence=>130
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762688583560123245)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'STARGAZERS_COUNT'
,p_sequence=>131
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762689008659123245)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'WATCHERS_COUNT'
,p_sequence=>132
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762689412094123246)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LANGUAGE'
,p_sequence=>133
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762689791764123246)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_ISSUES'
,p_sequence=>134
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762690265014123246)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_PROJECTS'
,p_sequence=>135
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762690657460123246)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_DOWNLOADS'
,p_sequence=>136
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762691054104123246)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_WIKI'
,p_sequence=>137
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762691401336123247)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_PAGES'
,p_sequence=>138
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762691776875123247)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORKS_COUNT'
,p_sequence=>139
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762692181539123247)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MIRROR_URL'
,p_sequence=>140
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762692622522123247)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ARCHIVED'
,p_sequence=>141
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762692990931123248)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'OPEN_ISSUES_COUNT'
,p_sequence=>142
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762693374857123248)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LICENSE'
,p_sequence=>143
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762693856863123249)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORKS'
,p_sequence=>144
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762694203590123249)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'OPEN_ISSUES'
,p_sequence=>145
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762694630914123250)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'WATCHERS'
,p_sequence=>146
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762695015216123250)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'DEFAULT_BRANCH'
,p_sequence=>147
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762695409690123250)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LABEL_2'
,p_sequence=>148
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762695864838123250)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REF_2'
,p_sequence=>149
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762696196586123250)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SHA_2'
,p_sequence=>150
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762696584537123251)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LOGIN_4'
,p_sequence=>151
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762697059851123251)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_6'
,p_sequence=>152
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762697431738123251)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AVATAR_URL_4'
,p_sequence=>153
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762697866154123251)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762698237427123251)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_6'
,p_sequence=>155
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762698639767123252)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_6'
,p_sequence=>156
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762699053495123252)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762699471982123253)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762699818852123253)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GISTS_URL_4'
,p_sequence=>159
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762700270210123253)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762700584182123253)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762701040092123253)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762701407971123254)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPOS_URL_4'
,p_sequence=>163
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762701782998123254)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_5'
,p_sequence=>164
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762702193951123254)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762702630158123254)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TYPE_4'
,p_sequence=>166
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762703045486123254)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SITE_ADMIN_4'
,p_sequence=>167
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762703407868123254)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_7'
,p_sequence=>168
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762703794540123255)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'NAME_2'
,p_sequence=>169
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762704227892123255)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FULL_NAME_2'
,p_sequence=>170
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762704670076123255)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LOGIN_5'
,p_sequence=>171
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762704981156123256)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ID_8'
,p_sequence=>172
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762705423467123256)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AVATAR_URL_5'
,p_sequence=>173
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762705820390123258)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762706236453123259)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_7'
,p_sequence=>175
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762706580331123259)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_7'
,p_sequence=>176
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762707071373123260)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762707376884123260)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762707856735123261)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GISTS_URL_5'
,p_sequence=>179
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762708266890123261)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762708620218123261)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762709058852123262)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762709437072123262)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPOS_URL_5'
,p_sequence=>183
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762709860602123262)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_6'
,p_sequence=>184
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762710196032123262)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762710647440123262)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TYPE_5'
,p_sequence=>186
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762710982177123263)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SITE_ADMIN_5'
,p_sequence=>187
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762711444973123263)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PRIVATE_2'
,p_sequence=>188
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762711790324123263)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_8'
,p_sequence=>189
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762712227630123264)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762712602897123264)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORK_2'
,p_sequence=>191
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762712996422123264)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_8'
,p_sequence=>192
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762713429978123265)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORKS_URL_2'
,p_sequence=>193
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762713788974123265)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'KEYS_URL_2'
,p_sequence=>194
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762714210622123265)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762714671659123266)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TEAMS_URL_2'
,p_sequence=>196
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762715012422123266)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HOOKS_URL_2'
,p_sequence=>197
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762715403357123270)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762715827062123271)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_7'
,p_sequence=>199
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762716255002123271)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762716657619123271)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762717057910123272)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TAGS_URL_2'
,p_sequence=>202
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762717420445123272)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'BLOBS_URL_2'
,p_sequence=>203
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762717785366123272)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762718176392123272)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762718638252123272)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TREES_URL_2'
,p_sequence=>206
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762719057309123273)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762719392901123273)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762719845280123273)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762720256477123273)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762720666043123274)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762721064259123274)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762721440801123274)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762721819919123275)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762722175959123275)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762722596438123276)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762723048330123276)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762723403109123276)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762723775323123276)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MERGES_URL_2'
,p_sequence=>219
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762724180680123276)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762724652358123277)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762725032132123277)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ISSUES_URL_2'
,p_sequence=>222
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762725467516123277)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PULLS_URL_2'
,p_sequence=>223
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762725805087123277)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762726244262123278)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762726596989123278)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LABELS_URL_2'
,p_sequence=>226
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762726996335123278)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762727399706123278)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762727829991123279)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CREATED_AT_3'
,p_sequence=>229
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762728228215123279)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'UPDATED_AT_3'
,p_sequence=>230
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762728606732123279)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'PUSHED_AT_2'
,p_sequence=>231
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762728979728123279)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GIT_URL_2'
,p_sequence=>232
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762729436991123279)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SSH_URL_2'
,p_sequence=>233
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762729775694123279)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'CLONE_URL_2'
,p_sequence=>234
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762730186512123280)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SVN_URL_2'
,p_sequence=>235
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762730625837123280)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HOMEPAGE_2'
,p_sequence=>236
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762731027940123280)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SIZE_2'
,p_sequence=>237
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762731421716123280)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762731792810123281)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762732198195123282)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LANGUAGE_2'
,p_sequence=>240
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762732594372123282)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_ISSUES_2'
,p_sequence=>241
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762733053178123282)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762733429371123282)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762733819668123282)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_WIKI_2'
,p_sequence=>244
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762734272889123283)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HAS_PAGES_2'
,p_sequence=>245
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762734653100123283)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762735021241123283)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'MIRROR_URL_2'
,p_sequence=>247
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762735381004123283)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ARCHIVED_2'
,p_sequence=>248
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762735872721123284)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762736215097123284)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'LICENSE_2'
,p_sequence=>250
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762736593330123284)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'FORKS_2'
,p_sequence=>251
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762737074163123284)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762737431052123284)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'WATCHERS_2'
,p_sequence=>253
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762737835279123284)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762738220879123285)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF'
,p_sequence=>255
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762738591812123285)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_2'
,p_sequence=>256
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762738985382123285)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_3'
,p_sequence=>257
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762739437827123285)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_4'
,p_sequence=>258
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762739851869123285)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_5'
,p_sequence=>259
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762740198973123286)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_6'
,p_sequence=>260
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762740626517123286)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_7'
,p_sequence=>261
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762741028846123286)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HREF_8'
,p_sequence=>262
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762741459052123286)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AUTHOR_ASSOCIATION'
,p_sequence=>263
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762741841909123286)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPO'
,p_sequence=>264
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762742208164123287)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ASSIGNEE_LOGIN'
,p_sequence=>265
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762742645529123287)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'ASSIGNEE_ID'
,p_sequence=>266
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762742991508123287)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'AVATAR_URL_6'
,p_sequence=>267
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762743455639123287)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762743839429123288)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'URL_9'
,p_sequence=>269
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762744238040123288)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'HTML_URL_9'
,p_sequence=>270
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762744634196123288)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762745040481123288)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762745403436123289)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'GISTS_URL_6'
,p_sequence=>273
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762745865600123289)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762746233742123289)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762746609811123289)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762747042312123289)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'REPOS_URL_6'
,p_sequence=>277
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762747440385123290)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'EVENTS_URL_8'
,p_sequence=>278
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762747870456123290)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762748193749123290)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'TYPE_6'
,p_sequence=>280
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(762748604348123290)
,p_data_profile_id=>wwv_flow_imp.id(762636501675123159)
,p_name=>'SITE_ADMIN_6'
,p_sequence=>281
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(91410258280483379)
,p_name=>'Sample Application - Github Repository Commits'
,p_static_id=>'Sample_Application___Github_Repository_Commits'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(91388819039483370)
,p_remote_server_id=>wwv_flow_imp.id(750255372996446286)
,p_url_path_prefix=>'repos/oracle/:repo/commits'
,p_pass_ecid=>true
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(91410929875483381)
,p_web_src_module_id=>wwv_flow_imp.id(91410258280483379)
,p_name=>'repo'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(91410525845483380)
,p_web_src_module_id=>wwv_flow_imp.id(91410258280483379)
,p_operation=>'GET'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(762611548379086576)
,p_name=>'Sample Application - Github Repositories'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(762611774774086576)
,p_web_src_module_id=>wwv_flow_imp.id(762611548379086576)
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
,p_force_error_for_http_404=>false
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(762635347000116693)
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(762636068003116693)
,p_web_src_module_id=>wwv_flow_imp.id(762635347000116693)
,p_name=>'repo'
,p_param_type=>'URL_PATTERN'
,p_data_type=>'VARCHAR2'
,p_is_required=>false
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(762635605471116693)
,p_web_src_module_id=>wwv_flow_imp.id(762635347000116693)
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(762749052283123290)
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(762749773814123291)
,p_web_src_module_id=>wwv_flow_imp.id(762749052283123290)
,p_name=>'repo'
,p_param_type=>'URL_PATTERN'
,p_data_type=>'VARCHAR2'
,p_is_required=>false
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(762749299520123291)
,p_web_src_module_id=>wwv_flow_imp.id(762749052283123290)
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(101146871209978601)
,p_name=>'Home Page'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(101147434148978602)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(101147868425978602)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115356432108577284)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(101304563242506611)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(101273803934447706)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3175185404421961057)
,p_name=>'admin options'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3175185601155961062)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3983683571013077123)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(101266846565409686)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1868201430983913270)
,p_list_item_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3175193801146073721)
,p_name=>'REST Examples'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1863991450822120655)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1863991715170120655)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1863992693899126360)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1865572817853825442)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3631449168514746257)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1863986284367102324)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(762750337323133095)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(114953308289849534)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(92333859364980403)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(762875603781533501)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3677971987700711665)
...
,p_list_item_disp_condition=>'SAMPLE_SERVICE_AVAILABLE'
,p_list_item_disp_condition2=>'OK'
,p_parent_list_item_id=>wwv_flow_imp.id(762875603781533501)
,p_list_text_01=>'Display data from external REST service as a tabular report.'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3677972252048711665)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3677973230777717370)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1865527330863588698)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3660686652993594319)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3631488451563793425)
,p_name=>'Navigation Bar (Top)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3631488638057793432)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3631489089855793438)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3631489481879793439)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Sign Out'
,p_list_item_link_target=>'&LOGOUT_URL.'
,p_parent_list_item_id=>wwv_flow_imp.id(3631489089855793438)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(571806636612382336)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(571806889501382352)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(571807131926382371)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(40824743814340386)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>187800382
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(42391412069867435)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(42421248045834977)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>37167665079388
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(42421629552834978)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(42441906863676616)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(140671041778229283)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(162269913813101059)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(164040373477818846)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(216955748729847199)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(647653693443129145)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37166093929872
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1875119250234013893)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1960975097268959642)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(2977913909167313587)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3624119103628193631)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(101304981583514258)
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(3175185294002950930)
,p_icon_sequence=>10
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(10649213769543085760)
,p_icon_sequence=>20
,p_icon_subtext=>'Help'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(10649214484088089874)
,p_icon_sequence=>30
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(1859055824449538503)
...
begin
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(1868188527995678581)
...
begin
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(3412003106828447553)
,p_process_sequence=>1
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1859055476355503796)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1868188300167609501)
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3187243820960865399)
,p_lov_name=>'STATUS LOV'
,p_lov_query=>'.'||wwv_flow_imp.id(3187243820960865399)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089080203
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3187244095846865399)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Deleted'
,p_lov_return_value=>'D'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3187244392572865402)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'New'
,p_lov_return_value=>'N'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3187244694012865402)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Original'
,p_lov_return_value=>'O'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3187245010487865402)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(3175199817478182526)
,p_name=>'breadcrumbs'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(92473630923120131)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
,p_short_name=>'Web Sources and PL/SQL'
,p_link=>'f?p=&APP_ID.:223:&SESSION.::&DEBUG.:::'
,p_page_id=>223
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(100388393111707377)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(101218451070224103)
,p_parent_id=>wwv_flow_imp.id(3175206189357217304)
,p_short_name=>'REST Endpoints Status'
,p_link=>'f?p=&FLOW_ID.:301:&SESSION.'
,p_page_id=>301
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(114954140255849540)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1865568646243781234)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1865568801670783273)
,p_short_name=>'Sample REST Services'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1865569098891785312)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1865569634899786692)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1865570101768791163)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3175205494887213966)
,p_parent_id=>wwv_flow_imp.id(3175206189357217304)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3175206189357217304)
,p_parent_id=>wwv_flow_imp.id(1865568801670783273)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3983677239684063140)
,p_parent_id=>wwv_flow_imp.id(3175206189357217304)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5170663493459752789)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044376971682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044483778682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044544370682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044655664682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044749164682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044839992682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183044950465682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183045093716682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183045115182682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183045299635682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183045320912682578)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183045494595682577)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(183045580799682577)
,p_plug_template_id=>wwv_flow_imp.id(5170663493459752789)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(3631407822088738807)
,p_theme_id=>42
...
,p_default_header_template=>wwv_flow_imp.id(3631373152566738689)
,p_default_footer_template=>wwv_flow_imp.id(3631373152566738689)
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(115340492257535933)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_theme_file(
 p_id=>wwv_flow_imp.id(115340902402535940)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69890676671646249)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69894665807646252)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69896650891646253)
,p_theme_id=>42
,p_name=>'ICON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69899842371646255)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69908298915646260)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
,p_display_name=>'Display Mode'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69918281573646267)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(69922304781646269)
,p_theme_id=>42
,p_name=>'COLOR_ACCENTS'
,p_display_name=>'Color Accents'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827627435407539154)
,p_theme_id=>142
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827627751728539154)
,p_theme_id=>142
,p_name=>'DISPLAY_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827629651424539158)
,p_theme_id=>142
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827630080464539158)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827631803103539162)
,p_theme_id=>142
,p_name=>'BODY_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827632259246539162)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827632596830539162)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827633614648539163)
,p_theme_id=>142
,p_name=>'REGION_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827634671279539164)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827635385678539166)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827635685183539166)
,p_theme_id=>142
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827637712738539171)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827638125698539171)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827638477013539171)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827639881473539175)
,p_theme_id=>142
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827640796166539178)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827642279172539180)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827643399261539181)
,p_theme_id=>142
,p_name=>'ICON_STYLE'
,p_display_name=>'Icon Style'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827645219301539185)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827646412242539188)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827647112374539189)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827648408871539194)
,p_theme_id=>142
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827648712195539194)
,p_theme_id=>142
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827649020127539194)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827649409367539194)
,p_theme_id=>142
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827649755861539194)
,p_theme_id=>142
,p_name=>'BUTTON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827650276586539194)
,p_theme_id=>142
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827651052285539195)
,p_theme_id=>142
,p_name=>'BUTTON_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827651561788539195)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827652008672539195)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827652382479539195)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827652644018539195)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2827652935923539195)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2889488711901838261)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(2912158886874920735)
,p_theme_id=>142
,p_name=>'CURRENT_PAGE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3071561444714493408)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3071567385792493418)
,p_theme_id=>142
,p_name=>'LIST_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3110807097442806045)
,p_theme_id=>142
,p_name=>'DIALOG_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3110809481810806047)
,p_theme_id=>142
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3110828584505806082)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3196907685623745843)
,p_theme_id=>142
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3200414281273103164)
,p_theme_id=>142
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(3376658880514192486)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(10563475101487172413)
,p_name=>'APEX Auth'
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3176784808111201974)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(649699277737659605)
,p_plugin_id=>wwv_flow_imp.id(3176784808111201974)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(649699633411659605)
,p_plugin_id=>wwv_flow_imp.id(3176784808111201974)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3517818566636048710)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(100453208882784162)
...
,p_list_id=>wwv_flow_imp.id(101146871209978601)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1800053131288651718)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3672955037081923175)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1800053185500651719)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(3175199817478182526)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5482029586163132402)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6704002870795223783)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6893032996820046004)
,p_plug_name=>'Footer'
,p_plug_display_sequence=>60
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.SAMPLEAPPFOOTER'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(13910136839380555642)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865578722856855972)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865578853561855973)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865578914796855974)
,p_query_column_id=>3
,p_column_alias=>'JOB'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865579053830855975)
,p_query_column_id=>4
,p_column_alias=>'MGR'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865579112014855976)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865579235303855977)
,p_query_column_id=>6
,p_column_alias=>'SAL'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865579263343855978)
,p_query_column_id=>7
,p_column_alias=>'COMM'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865579441218855979)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865579551889855980)
,p_query_column_id=>9
,p_column_alias=>'RN'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865581487599856000)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1863918759519935084)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(13910136839380555642)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1863920592263935087)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1800053317477651720)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7291125801224377661)
,p_plug_name=>'REST Service Endpoint'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody:margin-top-lg'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8513099085856469042)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8702129211881291263)
,p_plug_name=>'Footer'
,p_plug_display_sequence=>60
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.SAMPLEAPPFOOTER'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(15719233054441800901)
,p_name=>'Data from RESTful Service'
,p_region_name=>'report'
,p_template=>4072358936313175081
,p_display_sequence=>40
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863925056939937830)
,p_query_column_id=>1
,p_column_alias=>'EMPNO'
,p_column_display_sequence=>3
,p_column_heading=>'Empno'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863925555328937830)
,p_query_column_id=>2
,p_column_alias=>'ENAME'
,p_column_display_sequence=>4
,p_column_heading=>'Ename'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863925924629937831)
,p_query_column_id=>3
,p_column_alias=>'JOB'
,p_column_display_sequence=>5
,p_column_heading=>'Job'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863926354164937831)
,p_query_column_id=>4
,p_column_alias=>'MGR'
,p_column_display_sequence=>6
,p_column_heading=>'Mgr'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863926738759937831)
,p_query_column_id=>5
,p_column_alias=>'HIREDATE'
,p_column_display_sequence=>7
,p_column_heading=>'Hiredate'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863927071050937832)
,p_query_column_id=>6
,p_column_alias=>'SAL'
,p_column_display_sequence=>8
,p_column_heading=>'Sal'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863927492781937832)
,p_query_column_id=>7
,p_column_alias=>'COMM'
,p_column_display_sequence=>9
,p_column_heading=>'Comm'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863927862164937832)
,p_query_column_id=>8
,p_column_alias=>'DEPTNO'
,p_column_display_sequence=>10
,p_column_heading=>'Deptno'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863928326032937833)
,p_query_column_id=>9
,p_column_alias=>'RN'
,p_column_display_sequence=>2
,p_column_heading=>'Row #'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865581595664856001)
,p_query_column_id=>10
,p_column_alias=>'DERIVED$01'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1863929097441937834)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15719233054441800901)
,p_button_name=>'PREV'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1863928736922937833)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863929533330937834)
,p_name=>'P3_URL_PREV_PAGE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15719233054441800901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863929865993937839)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863930265792937839)
,p_name=>'P3_SHOW_PAGE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(15719233054441800901)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863931320693937840)
,p_name=>'P3_THIS_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7291125801224377661)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1863931660091937841)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Fetch data into Collection'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1800053358794651721)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9104900993212835257)
,p_plug_name=>'REST Service Endpoint'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody:margin-top-lg'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10326874277844926638)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10515904403869748859)
,p_plug_name=>'Footer'
,p_plug_display_sequence=>60
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.SAMPLEAPPFOOTER'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17533008246430258497)
,p_name=>'Data from RESTful Service'
,p_region_name=>'report'
,p_template=>4072358936313175081
,p_display_sequence=>40
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863936220113940970)
,p_query_column_id=>1
,p_column_alias=>'EMPNO'
,p_column_display_sequence=>3
,p_column_heading=>'Empno'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863936576265940971)
,p_query_column_id=>2
,p_column_alias=>'ENAME'
,p_column_display_sequence=>4
,p_column_heading=>'Ename'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863937010533940971)
,p_query_column_id=>3
,p_column_alias=>'JOB'
,p_column_display_sequence=>5
,p_column_heading=>'Job'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863937365869940971)
,p_query_column_id=>4
,p_column_alias=>'MGR'
,p_column_display_sequence=>6
,p_column_heading=>'Mgr'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863937807585940972)
,p_query_column_id=>5
,p_column_alias=>'HIREDATE'
,p_column_display_sequence=>7
,p_column_heading=>'Hiredate'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863938253877940972)
,p_query_column_id=>6
,p_column_alias=>'SAL'
,p_column_display_sequence=>8
,p_column_heading=>'Sal'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863938606936940973)
,p_query_column_id=>7
,p_column_alias=>'COMM'
,p_column_display_sequence=>9
,p_column_heading=>'Comm'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863938966729940973)
,p_query_column_id=>8
,p_column_alias=>'DEPTNO'
,p_column_display_sequence=>10
,p_column_heading=>'Deptno'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1863939446568940974)
,p_query_column_id=>9
,p_column_alias=>'RN'
,p_column_display_sequence=>2
,p_column_heading=>'Row #'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1865580633594855991)
,p_query_column_id=>10
,p_column_alias=>'DERIVED$01'
,p_column_display_sequence=>1
,p_column_heading=>'&nbsp;'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1863940217436940974)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(17533008246430258497)
,p_button_name=>'PREV'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1863939787854940974)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(17533008246430258497)
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1863944021360940984)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1852381426516012267)
,p_name=>'P4_CASE_SENSITIVE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(17533008246430258497)
,p_item_default=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863940634496940975)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863941034581940975)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863941368656940975)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863941819434940976)
,p_name=>'P4_SHOW_PAGE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(17533008246430258497)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1863942829859940982)
,p_name=>'P4_THIS_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9104900993212835257)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1863943527165940983)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Fetch data into Collection'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3983674039118063135)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3983674484121063137)
,p_plug_name=>'items'
,p_parent_plug_id=>wwv_flow_imp.id(3983674039118063135)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3983675271911063138)
,p_plug_name=>'About this page'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3983675641553063139)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3983676100407063139)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3983675641553063139)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3983676412165063139)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3983675641553063139)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3983677960473063141)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(3983676412165063139)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3983674863193063137)
,p_name=>'P5_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3983674484121063137)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3983677416325063141)
,p_process_sequence=>10
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3983676412165063139)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1852380368197012256)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1852380570321012258)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1852380706400012260)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1852380570321012258)
,p_button_name=>'CANCEL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1852380593665012259)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1852380570321012258)
,p_button_name=>'APPLY'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1852381568794012268)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1852380394343012257)
,p_name=>'P6_ENDPOINT_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1852380368197012256)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(505889257923972615)
...
,p_associated_item=>wwv_flow_imp.id(1852380394343012257)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1852380779478012261)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1852380706400012260)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1852380918906012262)
,p_event_id=>wwv_flow_imp.id(1852380779478012261)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1852381027521012263)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1852380593665012259)
,p_process_success_message=>'REST Service Endpoint set. '
,p_internal_uid=>1811556922634671885
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1852381186210012265)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3905762884562370470)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5170661720113614736)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_imp.id(3905762884562370470)
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5170661916981614737)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5170662120171614737)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3905762940680370471)
,p_name=>'&APP_NAME.'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3905763049045370472)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3905763196740370473)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3905763296610370474)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5170661093824614729)
,p_plug_name=>'Help'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(130188837290615831)
,p_plug_name=>'About this Page'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2519595706319178779)
,p_plug_name=>'&APP_NAME.'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2674017834225413037
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2571922621696539314)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2571922746212539315)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2571922792325539316)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2571923877932539327)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2601078376117723117)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2601078482040723118)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4392497494295450235)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(3175193801146073721)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2886769488667748277
,p_plug_display_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_plug_display_when_condition=>'SAMPLE_SERVICE_AVAILABLE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4392497612112450236)
,p_plug_name=>'About this Page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(762879332851546820)
,p_name=>'P10_APEX_OWNER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2571922621696539314)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(762880334874546827)
,p_name=>'P10_REST_VERSION_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2571922792325539316)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(762881434839546835)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(762881774731546835)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1800052055602651707)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1800052059207651708)
,p_region_id=>wwv_flow_imp.id(1800052055602651707)
,p_chart_type=>'combo'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1800052240575651709)
,p_chart_id=>wwv_flow_imp.id(1800052059207651708)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1800052472384651712)
,p_chart_id=>wwv_flow_imp.id(1800052059207651708)
,p_seq=>20
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1800052600861651713)
,p_chart_id=>wwv_flow_imp.id(1800052059207651708)
,p_seq=>30
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1800052381556651711)
,p_chart_id=>wwv_flow_imp.id(1800052059207651708)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1800052718050651714)
,p_chart_id=>wwv_flow_imp.id(1800052059207651708)
,p_axis=>'y2'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1800052288240651710)
,p_chart_id=>wwv_flow_imp.id(1800052059207651708)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1800052831813651715)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8519515614479260964)
,p_plug_name=>'About this page'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8708545740504083185)
,p_plug_name=>'Footer'
,p_plug_display_sequence=>60
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.SAMPLEAPPFOOTER'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15725649583064592823)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(15725649667635592823)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865530974272588746)
,p_db_column_name=>'RN'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865528355395588739)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865528657009588744)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865529033303588744)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865529394633588744)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865529804262588745)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865530205204588745)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1865530638464588745)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(15725651183487593331)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1800052920822651716)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1800052831813651715)
,p_button_name=>'PURGE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1800051638653651703)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1800052831813651715)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1800051694139651704)
,p_branch_action=>'f?p=&APP_ID.:&APP_PAGE_ID.:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1800051839370651705)
,p_name=>'P11_ROWS_LOADED'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15725649583064592823)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1800051910236651706)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1800051541212651702)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1800052920822651716)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1865579577910855981)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1865580671873855992)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10920511962201956022)
,p_plug_name=>'REST Service Endpoint'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody:margin-top-lg'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(12142485246834047403)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1865580793226855993)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1865580671873855992)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1865581013678855995)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1865580671873855992)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1865581417615855999)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865579695381855982)
,p_name=>'P12_EMPNO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Empno'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865579805343855983)
,p_name=>'P12_MGR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865579857394855984)
,p_name=>'P12_JOB'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Job'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865579960161855985)
,p_name=>'P12_COMM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Commission'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865580069083855986)
,p_name=>'P12_ENAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Name'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865580162415855987)
,p_name=>'P12_HIREDATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Hire Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865580350481855988)
,p_name=>'P12_SAL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Salary'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865580377658855989)
,p_name=>'P12_DEPTNO'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(1865579577910855981)
,p_prompt=>'Department #'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1865581337489855998)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1865581117923855996)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1865581013678855995)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1865581176491855997)
,p_event_id=>wwv_flow_imp.id(1865581117923855996)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1865633630783672340)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Fetch data into Collection'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1865580526717855990)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1865580902918855994)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1865580793226855993)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3175186219317961063)
...
,p_plug_display_sequence=>10
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(3175185404421961057)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3175205906920217302)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3175204609264213963)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3175205304539213966)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3175204805748213963)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3175205304539213966)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3175205020365213964)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3175205304539213966)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3175206597016222952)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3175205600843213966)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10594603188046233529)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7758280305168107635)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10594603188046233529)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10594603271127233537)
,p_name=>'P101_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(10594603188046233529)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10594603377091233539)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3153841392896762221)
,p_name=>'Set Focus'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3153841691002762224)
,p_event_id=>wwv_flow_imp.id(3153841392896762221)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3153841900313762227)
,p_event_id=>wwv_flow_imp.id(3153841392896762221)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10594603669782233549)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10594603566618233541)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10594603773624233549)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10594603875436233549)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(100387985856707377)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(759227016141536262)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(762761914863137832)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(762762069555137833)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762080776137834)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762272554137835)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762307281137836)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762592629137839)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762764164775137854)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763942630137852)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762812705137841)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763019170137843)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763121912137844)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763239598137845)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763281072137846)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763432497137847)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763553240137848)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763611274137849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763720666137850)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762763815827137851)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762763466137840)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762764176580137855)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762426140137837)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762972716137842)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762762492387137838)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762764023536137853)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(762764275477137856)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(762806248194153479)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'CHART'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(90007525490606441)
,p_name=>'Show Issues'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(90007849645606444)
,p_name=>'Show Pulls'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P221_DETAIL'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(90009596648606462)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90009681390606463)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90009842733606464)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90009966400606465)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90010047870606466)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90010187086606468)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90010322288606469)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(91432851184511920)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(91432949625511921)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(91433043757511922)
,p_query_column_id=>9
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(91433171485511923)
,p_page_id=>222
,p_web_src_param_id=>wwv_flow_imp.id(91410929875483381)
,p_page_plug_id=>wwv_flow_imp.id(90009596648606462)
,p_value_type=>'ITEM'
,p_value=>'P222_REPO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(91435531483511947)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(91435591220511948)
,p_page_id=>222
,p_web_src_param_id=>wwv_flow_imp.id(91410929875483381)
,p_page_plug_id=>wwv_flow_imp.id(91435531483511947)
,p_value_type=>'ITEM'
,p_value=>'P222_REPO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(100451510482784145)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(100451586703784146)
,p_region_id=>wwv_flow_imp.id(100451510482784145)
,p_chart_type=>'donut'
,p_height=>'500'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(100451757158784147)
,p_chart_id=>wwv_flow_imp.id(100451586703784146)
,p_seq=>10
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(100451983809784150)
,p_page_id=>222
,p_web_src_param_id=>wwv_flow_imp.id(91410929875483381)
,p_jet_chart_series_id=>wwv_flow_imp.id(100451757158784147)
,p_value_type=>'ITEM'
,p_value=>'P222_REPO'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(137238670389773610)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90568179378186909)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>3
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(759227163212536263)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90568668597186910)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(759227592210536268)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(759227181051536264)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(759227288400536265)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(759227375040536266)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90570244961186911)
,p_query_column_id=>8
,p_column_alias=>'ID_2'
,p_column_display_sequence=>4
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(759227507736536267)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90571017592186911)
,p_query_column_id=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90571461467186912)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90571819961186912)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(90009478990606461)
,p_page_id=>222
,p_web_src_param_id=>wwv_flow_imp.id(762749773814123291)
,p_page_plug_id=>wwv_flow_imp.id(137238670389773610)
,p_value_type=>'ITEM'
,p_value=>'P222_REPO'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(759227774020536269)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100450042790784130)
,p_query_column_id=>1
,p_column_alias=>'CARD_TEXT'
,p_column_display_sequence=>6
,p_column_heading=>'Card text'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100450142717784131)
,p_query_column_id=>2
,p_column_alias=>'CARD_INITIALS'
,p_column_display_sequence=>7
,p_column_heading=>'Card initials'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100449213394784122)
,p_query_column_id=>3
,p_column_alias=>'EMAIL'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100450217616784132)
,p_query_column_id=>4
,p_column_alias=>'CARD_TITLE'
,p_column_display_sequence=>8
,p_column_heading=>'Card title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100449416614784124)
,p_query_column_id=>5
,p_column_alias=>'COMMITTER_NAME'
,p_column_display_sequence=>2
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100450354443784133)
,p_query_column_id=>6
,p_column_alias=>'CARD_SUBTEXT'
,p_column_display_sequence=>9
,p_column_heading=>'Card subtext'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100449631885784126)
,p_query_column_id=>7
,p_column_alias=>'COMMENT_COUNT'
,p_column_display_sequence=>3
,p_column_heading=>'Comments'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100450384822784134)
,p_query_column_id=>8
,p_column_alias=>'CARD_LINK'
,p_column_display_sequence=>10
,p_column_heading=>'Card link'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100449815259784128)
,p_query_column_id=>9
,p_column_alias=>'COMMITTER_LOGIN'
,p_column_display_sequence=>4
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(100449917580784129)
,p_query_column_id=>10
,p_column_alias=>'COMMITTER_IMAGE'
,p_column_display_sequence=>5
,p_hidden_column=>'Y'
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(100449001967784120)
,p_page_id=>222
,p_web_src_param_id=>wwv_flow_imp.id(91410929875483381)
,p_page_plug_id=>wwv_flow_imp.id(759227774020536269)
,p_value_type=>'ITEM'
,p_value=>'P222_REPO'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(810001609723305962)
,p_name=>'Issues'
,p_template=>4072358936313175081
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90009213411606458)
,p_query_column_id=>1
,p_column_alias=>'HTML_URL'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90573026268187825)
,p_query_column_id=>2
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90573389473187825)
,p_query_column_id=>3
,p_column_alias=>'NUMBER_'
,p_column_display_sequence=>2
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90573867253187826)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90574234979187826)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90574637750187826)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90575004354187826)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90575410566187827)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90575804751187827)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90576201235187827)
,p_query_column_id=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90576605166187828)
,p_query_column_id=>11
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90577072790187828)
,p_query_column_id=>12
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90577384718187828)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90577794216187829)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90578205698187829)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90578660808187829)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90579047440187830)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90579453802187830)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90579861667187831)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(90580240742187831)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(90009303692606459)
,p_page_id=>222
,p_web_src_param_id=>wwv_flow_imp.id(762636068003116693)
,p_page_plug_id=>wwv_flow_imp.id(810001609723305962)
,p_value_type=>'ITEM'
,p_value=>'P222_REPO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(810103127810507916)
,p_plug_name=>'RDS'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90008212314606448)
,p_name=>'P222_REPO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(810103127810507916)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(90008394538606450)
,p_name=>'Show Issues'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(90008493735606451)
,p_event_id=>wwv_flow_imp.id(90008394538606450)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(810001609723305962)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(90008611872606452)
,p_event_id=>wwv_flow_imp.id(90008394538606450)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(90008761687606453)
,p_name=>'Show Pulls'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P222_DETAIL'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(90008839653606454)
,p_event_id=>wwv_flow_imp.id(90008761687606453)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(137238670389773610)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(90008915917606455)
,p_event_id=>wwv_flow_imp.id(90008761687606453)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(91433528068511927)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452186372784152)
,p_name=>'NAME'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452365437784153)
,p_name=>'LANGUAGE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452450292784154)
,p_name=>'DESCRIPTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452565152784155)
,p_name=>'UPDATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452634173784156)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452709424784157)
,p_name=>'ISSUES_CNT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452842674784158)
,p_name=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100452891649784159)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(100453064964784160)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(100452080751784151)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(100737139482951332)
,p_interactive_grid_id=>wwv_flow_imp.id(100452080751784151)
,p_static_id=>'14581'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(100737181033951332)
,p_report_id=>wwv_flow_imp.id(100737139482951332)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100737718759951337)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(100452186372784152)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100738154019951342)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(100452365437784153)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100738653963951344)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(100452450292784154)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100739097049951345)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(100452565152784155)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100739614323951346)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(100452634173784156)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100740105361951348)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(100452709424784157)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100741176726953038)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(100452842674784158)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(100741741285953040)
,p_view_id=>wwv_flow_imp.id(100737181033951332)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(100452891649784159)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(91435703349511949)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(91435794548511950)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92473273447120130)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(91436033672511952)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(92473273447120130)
,p_button_name=>'Clear'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(91435059834511942)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(92473273447120130)
,p_button_name=>'Download'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(91433366246511925)
,p_name=>'P223_REPO_CNT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(91435703349511949)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(91435114634511943)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(91436033672511952)
,p_process_success_message=>'Local data deleted.'
,p_internal_uid=>50612067643171575
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(100453092782784161)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(91433528068511927)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(91433386614511926)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114953824071849540)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114991403802917833)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(114991497656917834)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114991599926917835)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114991694761917836)
,p_db_column_name=>'NAME'
,p_display_order=>20
,p_column_identifier=>'B'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114992559645917844)
,p_db_column_name=>'HOMEPAGE'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'Homepage'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114992659528917845)
,p_db_column_name=>'SIZE_'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'Size '
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114992908180917848)
,p_db_column_name=>'LANGUAGE'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'Language'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114993877515917858)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115329815428149007)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(115333220706163187)
,p_report_id=>wwv_flow_imp.id(115329815428149007)
,p_name=>'Local Data'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114994132796917860)
,p_plug_name=>'Information'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114994226267917861)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(100453335114784163)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101196022091178648)
,p_query_column_id=>1
,p_column_alias=>'CARD_TITLE'
,p_column_display_sequence=>3
,p_column_heading=>'Card title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101195474024178642)
,p_query_column_id=>2
,p_column_alias=>'URL'
,p_column_display_sequence=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101195477893178643)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101196143237178649)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101196272799178650)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101196480239178653)
,p_query_column_id=>6
,p_column_alias=>'CARD_TEXT'
,p_column_display_sequence=>7
,p_column_heading=>'Card text'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(101196425135178652)
,p_query_column_id=>7
,p_column_alias=>'CARD_SUBTEXT'
,p_column_display_sequence=>6
,p_column_heading=>'Card subtext'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(101196606718178654)
,p_plug_name=>'Information'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(101218071321224102)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(101195663856178644)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(101218071321224102)
,p_button_name=>'TEST'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(101195817246178646)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(101195663856178644)
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(200787744717428541)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(203407018001450559)
,p_install_id=>wwv_flow_imp.id(200787744717428541)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(203407248030454513)
,p_install_id=>wwv_flow_imp.id(200787744717428541)
...
-- sqlcl_snapshot {"hash":"c06484ba92d9667ba5acda820e9c5e3e97c4c63b","type":"APEX_APPLICATIONS","name":"f119","schemaName":"MOVIESTREAM","sxml":""}