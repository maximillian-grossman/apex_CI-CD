create or replace package body eba_demo_md_data_pkg as
    ...
    ---------------------------------- 
        ...
        insert into eba_demo_md_status (
            cd,
            description,
            display_order
        ) values ( 'ASSIGNED',
    ...
    -- Insert Project Comments for Project 1 
        ...
        set
            created = to_date('20141202', 'YYYYMMDD') + l_add_days,
            created_by = 'TKING'
        where
            id = 1;
        ...
        update eba_demo_md_comments
        set
            created = to_date('20141204', 'YYYYMMDD') + l_add_days,
            created_by = 'MEIYU'
        where
            id = 2;
    ...
    -- Insert Project Comments for Project 2 
        ...
        update eba_demo_md_comments
        set
            created = to_date('20141211', 'YYYYMMDD') + l_add_days
        where
            id = 4;
        ...
        update eba_demo_md_comments
        set
            created = to_date('20141212', 'YYYYMMDD') + l_add_days,
            created_by = 'TKING'
        where
            id = 5;
    ...
    -- Insert Project Comments for Project 3 
        ...
        update eba_demo_md_comments
        set
            created = to_date('201412310100', 'YYYYMMDDHH24MI') + l_add_days,
            created_by = 'THEBROCK'
        where
            id = 6;
        ...
        update eba_demo_md_comments
        set
            created = to_date('201412310200', 'YYYYMMDDHH24MI') + l_add_days,
            created_by = 'BERNIE'
        where
            id = 7;
        ...
        update eba_demo_md_comments
        set
            created = to_date('201412310300', 'YYYYMMDDHH24MI') + l_add_days,
            created_by = 'THEBROCK'
        where
            id = 8;
        ...
        update eba_demo_md_comments
        set
            created = to_date('201501010100', 'YYYYMMDDHH24MI') + l_add_days,
            created_by = 'BERNIE'
        where
            id = 9;
        ...
        update eba_demo_md_comments
        set
            created = to_date('201501010200', 'YYYYMMDDHH24MI') + l_add_days,
            created_by = 'THEBROCK'
        where
            id = 10;
        ...
        update eba_demo_md_comments
        set
            created = to_date('20141217', 'YYYYMMDD') + l_add_days,
            created_by = 'THALL'
        where
            id = 11;
...
-- sqlcl_snapshot {"hash":"6b6847b311a7b317525366614a87c06114a8db87","type":"PACKAGE_BODY","name":"EBA_DEMO_MD_DATA_PKG","schemaName":"MOVIESTREAM","sxml":""}